...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-gray-200 font-sans selection:bg-emerald-500/30 flex flex-col">
      {/* App Header */}
      <header className="bg-black/50 backdrop-blur-xl sticky top-0 z-50 pt-safe">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold text-lg tracking-tight text-white">Smart SOS</h1>
          </div>
                  ...
                  <div className="p-6 rounded-3xl bg-white/5 border border-white/10 space-y-6">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        ...
                        className="w-14 bg-emerald-600 text-white rounded-2xl flex items-center justify-center disabled:bg-gray-800 transition-colors"
                      >
